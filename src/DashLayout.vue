...
<template>
  <div class="grid grid-rows-[60px_1fr] grid-cols-[200px_1fr]">
    <nav
      class="bg-white border-gray-200 dark:bg-gray-900 row-start-1 row-end-2 col-start-1 col-end-3"
    >
    ...
    <aside
      id="default-sidebar"
      class="h-screen transition-transform -translate-x-full sm:translate-x-0 col-start-1 col-end-2 row-start-2 row-end-3"
      aria-label="Sidebar"
    >
    ...
    <div class="p-4 row-start-2 row-end-3 col-start-2 col-end-3">
